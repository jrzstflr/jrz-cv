...
const About = () => {
  ...
  return (
    <div id="about" className='text-white py-16'>
      ...
      className="text-3xl md:text-4xl font-bold mb-8 border-b-2 border-purple-500 inline-block">About Me</motion.h2>
      <motion.p 
      ref={ref}
      initial={{opacity:0, y:100}}
      animate={inView ? {opacity:1, y:0} : {}}
      transition={{delay: 0.5, duration: 0.5}}
      className="mb-12 text-gray-400 text-opacity-80">Hello, I'm Jeruz Abiera, a passionate Frontend Developer skilled in HTML, CSS, JavaScript, React and TailwindCSS. I love building creative and responsive web applications.
        </motion.p>
            ...
            <motion.div 
             ...
             className='text-center'>
                ...
                <motion.p
                 ...
                 className='text-sm sm:text-base text-gray-300'>Years of  Experience in VOIP with 8x8</motion.p>
            </motion.div>
            <motion.div 
             ref={ref}
             initial={{opacity:0}}
             ...
             transition={{delay: 1.6, duration: 0.3}}>
                ...
                <motion.p
                 ...
                 className='text-sm sm:text-base text-gray-300'>Overall Customer Service and Technical Support Experience</motion.p>
             </motion.div>
            ...
            <motion.div 
             ...
             transition={{delay: 1.6, duration: 0.3}}>
                ...
                <motion.p
                 ...
                 initial={{opacity:0, y:100}}
                 animate={inView ? {opacity:1, y:0} : {}}
                 transition={{delay: 1.9, duration: 0.5}} className='text-sm sm:text-base text-gray-300'>Projects I have made</motion.p> 
             </motion.div>
        </div>
      </div>
    </div>
